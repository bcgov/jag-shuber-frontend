...
//         super(namespace, actionName);
//     }
//     public async doWork(assignmentTemplate: Partial<AssignmentTemplate>, { api }: ThunkExtra): Promise<AssignmentTemplate> {
//         let newAssignmentTemplate = await api.createAssignmentTemplate(assignmentTemplate);
